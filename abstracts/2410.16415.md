...
**Topics:** Climate, Weather & Geophysics, Dynamical Systems & PDE Learning, Generative Models & Discovery, via:author-whitelist:PINNs, Bayesian SciML

**Tags:** data-assimilation, diffusion-models, inverse-problems, partial-differential-equations

**arXiv categories:** cs.LG, cs.AI

[arXiv abstract page](http://arxiv.org/abs/2410.16415) | [PDF](http://arxiv.org/pdf/2410.16415)
