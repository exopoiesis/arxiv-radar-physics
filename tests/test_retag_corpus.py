...
def test_retag_paper_adds_missing_tags(populated_data_dir, canonical_path):
    """Paper without tags but with physics terms in abstract gets tagged."""
    import retag_corpus
    _setup_paper(populated_data_dir, "We use DFT and graph neural networks for physics.")
...
def test_retag_paper_no_change_when_already_tagged(populated_data_dir, canonical_path):
    ...
    _setup_paper(populated_data_dir,
                 "We use DFT and graph neural networks for physics.",
